...
class Cifar10Net(tf.keras.Model):
    ...
    def __init__(self, input_shape):
        ...
        self.conv_1 = tf.keras.layers.Conv2D(4, 3, strides=1, padding='same', activation='tanh', input_shape=input_shape)
        # self.conv_2 = tf.keras.layers.Conv2D(32, 3, strides=1, activation='tanh')
        self.conv_3 = tf.keras.layers.Conv2D(8, 3, strides=1, activation='tanh')
